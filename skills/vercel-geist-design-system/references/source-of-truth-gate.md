...
- For UI that creates or materially changes rendered output, consult `https://vercel.com/design.md` first, then the official Vercel Font page plus Geist Introduction, Colors, Typography, Materials, Guidelines, and matching component pages. Also consult `https://vercel.com/design.dark.md` when dark mode, theme switching, dark screenshots, or dark tokens are in scope.
...
- Canonical tokens/defaults: `https://vercel.com/design.md` for light theme decisions; `https://vercel.com/design.dark.md` for dark mode, theme switching, or dark screenshots. These pages are alpha, so read the current document in the current turn before using exact token values or numeric defaults.
