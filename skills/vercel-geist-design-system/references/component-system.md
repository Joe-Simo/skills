...
- If the requirement is "full-page grid", "Vercel-like grid", "Vercel.com grid", "grid art", "dashboard grid", or "feature grid", first determine whether the user means ordinary responsive layout or the visible Vercel/Grid aesthetic. Explicit Vercel.com references, grid art, guide lines, visible cells, or supplied Vercel-like screenshots mean an intentional visible cell-and-guide surface. Otherwise default to a functional content grid with real cells, rows, columns, alignment, and borders.
